...
// import JobFilters from "./Jobfiltercontayner";
// import { useRouter } from "next/navigation";
// import { Pagination } from "@heroui/react";

// export default function JobListingContainer({ jobs , filter,total}) {
//   const [searchQuery, setSearchQuery] = useState(filter.search);
//   const [selectedType, setSelectedType] = useState(filter.jobType || "all");
//   const [selectedCategory, setSelectedCategory] = useState(filter.jobCategory || "all");
//   const [isRemoteOnly, setIsRemoteOnly] = useState(filter.isRemote || false);
//   const [page, setPage] = useState(filter.page || 1);
  

//   const router =useRouter();
//     const totalItems =jobs.total;
...
//   }, [router, searchQuery, selectedType, selectedCategory,page, isRemoteOnly])




//   // Axios এবং async/await ব্যবহার করে
...
//         Showing {jobs.jobs.length} position{jobs.jobs.length !== 1 && "s"}
//       </div>
